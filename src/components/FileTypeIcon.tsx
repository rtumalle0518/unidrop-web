...
export const FileTypeIcon = ({fileType} : FileTypeIconProps) => {
  ...
  if (f_type === 'application'){
    return (
      <PictureAsPdfIcon sx={{height: '30%', width: '30%'}}/>
    )
  } else if (f_type === 'image'){
    return (
      <ImageIcon sx={{height: '30%', width: '30%'}}/>
    )
  } else if (f_type === 'audio'){
    return (
      <AudioFileIcon sx={{height: '30%', width: '30%'}}/>
    )
  } else if (f_type === 'text'){
    if (arr[1] === 'plain'){
  ...
  return (
    <MiscellaneousServicesIcon sx={{height: '30%', width: '30%'}}/>
  )
}
